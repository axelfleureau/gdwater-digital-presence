  ...
  return <section className="py-16 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {certificazioni.map((cert, index) => <Card key={index} className="p-6 flex flex-col items-center text-center hover:shadow-lg transition-all duration-300 border border-gdwater-gray">
              <div className="h-24 flex items-center justify-center mb-4">
                <img src={cert.logo} alt={`Certificazione ${cert.name}`} className="max-h-full object-contain" />
              </div>
